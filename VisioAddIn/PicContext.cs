...
namespace VisioAddIn
{
    ...
    public class PicContext
    {
        ...
        /// <summary>
        /// Scale returns ratio of the Input range over PictureBoxRange
        /// </summary>
        ...
        public int ConvertFromWidthF(float width)
        {
            int ww = (int)Math.Round(width * Scaler.Width);
            return ww;
        }
        public int ConvertFromHeightF(float height)
        {
            int hh = (int)Math.Round(height * Scaler.Height);
            return hh;
        }
        ...
        public bool Draw(Graphics gg, SdxDataSetContext context, out string explanation)
        {
            ...
            try
            {
                ...
                {
                    explanation = $"SdxDatasetContext or Object dictionary is null.";
                    return false;
                }
        ...
        public void DrawLink(Graphics gg, SdxLink link)
        {
            ...
            foreach ( SdxVector vertex in link.VertexList)
            {
                ...
                {
                    int ww = ConvertFromWidthF((float) link.Width);
                    int hh = ConvertFromHeightF((float) -link.Height);
        ...
        public void DrawObject(Graphics gg, SdxObject obj)
        {
            ...
            int ww = ConvertFromWidthF((float)obj.Size.xLength);
            int hh = ConvertFromHeightF((float)obj.Size.zHeight);
        ...
        public void DrawArtifact(Graphics gg, SdxArtifact ai)
        {
            ...
            int ww = ConvertFromWidthF((float)ai.Size.xLength);
            int hh = ConvertFromHeightF((float)ai.Size.zHeight);
    ...
    public class PicObject
    {
        ...
        public void Recalculate(PicContext context)
        {
            ...
            int ww = context.ConvertFromWidthF(RectF.Width);
            int hh = context.ConvertFromHeightF(RectF.Height);
